...
const MiniQuizTurunan = () => {
  ...
  const checkAnswers = () => {
    const topicQuestions = questions.Turunan;  // Fokus hanya pada Integral
  ...
  return (
    <div>
      ...
      {/* Soal Pilihan Ganda */}
      {questions.Turunan.mcq.map((q, index) => (
        <div key={index}>
          <h4>{q.question}</h4>
      ...
      {/* Soal Essay */}
      {questions.Turunan.essay.map((q, index) => (
        <div key={index}>
          <h4>{q.question}</h4>
          <textarea
            rows="4"
      ...
      {/* Soal True/False */}
      {questions.Turunan.tf.map((q, index) => (
        <div key={index}>
          <h4>{q.question}</h4>
          <div>
            <input
