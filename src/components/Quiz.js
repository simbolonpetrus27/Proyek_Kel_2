...
function Quiz({ topic }) {
  ...
  const questions = [
    ...
    // Tambahkan lebih banyak pertanyaan sesuai topik
  ];
  ...
  const handleFinishQuiz = () => {
    ...
    // Cek jawaban pilihan ganda dan hitung skor
            ...
            {questions.map((question, index) => (
              <li key={index}>
                ...
                {question.type === "multiple-choice" ? (
                  <p>
                    Jawaban Anda: {answers[index]} {answers[index] === question.answer ? "(Benar)" : "(Salah)"}
                  </p>
                ) : (
                  <p>
