  ...
  return (
    <div style={styles.container}>
      <div style={styles.linkContainer}>
        {[
          { text: 'Materi', path: '/transformasi/materi' },
          { text: 'Soal', path: '/transformasi/contoh-soal' },
          { text: 'Pembahasan', path: '/transformasi/pembahasan' },
          { text: 'Mini Quiz', path: '/transformasi/miniquiz' },
        ].map((item, index) => (
