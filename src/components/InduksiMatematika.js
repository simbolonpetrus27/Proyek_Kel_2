...
import MateriInduksiMatematika from './MateriInduksiMatematika'; // Import komponen materi
import ContohSoalInduksiMatematika from './ContohSoalInduksiMatematika'; // Import komponen contoh soal
import PembahasanInduksiMatematika from './PembahasanInduksiMatematika'; // Import komponen pembahasan
import MiniQuizInduksiMatematika from './MiniQuizInduksiMatematika.js'; // Import komponen mini quiz
      ...
      <div style={styles.content}>
        ...
        {activeSection === 'materi' && (
          <div ref={materiRef} style={styles.section}>
            <MateriInduksiMatematika /> {/* Menampilkan Komponen Materi */}
          </div>
        )}
        ...
        {activeSection === 'contohSoal' && (
          <div ref={contohSoalRef} style={styles.section}>
            <ContohSoalInduksiMatematika /> {/* Menampilkan Komponen Contoh Soal */}
          </div>
        )}
        ...
        {activeSection === 'pembahasan' && (
          <div ref={pembahasanRef} style={styles.section}>
            <PembahasanInduksiMatematika /> {/* Menampilkan Komponen Pembahasan */}
          </div>
        )}
        ...
        {activeSection === 'miniQuiz' && (
          <div ref={miniQuizRef} style={styles.section}>
            <MiniQuizInduksiMatematika /> {/* Menampilkan Komponen Mini Quiz */}
          </div>
        )}
      </div>
    </div>
